        ...
        <table className="table table-hover table-striped table-bordered">
          <thead className="table-dark">
            <tr className="text-center">
              ...
              <th>FECHA Y HORA</th>
              <th>NACIONALIDAD</th>
              {data[0].gen_nac === "COLOMBIA" ? (
                <th>IDENTIFICACION</th>
              ) : (
                <Fragment>
                  <th>IDENTIFICACION PEP</th>
                  <th>IDENTIFICACION CEDULA EXTRANGERIA</th>
                  <th>PASAPORTE</th>
                </Fragment>
              )}
          ...
          <tbody>
            {data.map((name) => (
              <tr>
                ...
                <td>{name.gen_nac}</td>
                {name.gen_nac === "COLOMBIA" ? (
                  <td>{name.gen_ide}</td>
                ) : (
                  <Fragment>
                    <td>{name.gen_pep}</td>
                    <td>{name.gen_ide_ext}</td>
                    <td>{name.gen_pas}</td>
                  </Fragment>
                )}
